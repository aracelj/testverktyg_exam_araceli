...
[U1] As a user, I want to click the toggle icon beside a book in the catalog so that I can mark that book as a favorite.

[U2] As a user, I want to click the toggle icon again on a marked favorite book so that I can remove it from my favorite list and keep only the books I currently like.
